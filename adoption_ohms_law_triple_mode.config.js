...
var ADOPTION_CONFIG = {
  titles: {
    ...
    biz:   { tl: 'Hot demand',    tr: 'Transition demand',   bl: 'Dormant demand',  br: 'Phantom demand' }
  },
  labels: {
    phys:  { x: 'R  (resistance) →', y: 'V (potential difference) →', v: 'V',       r: 'R',     i: 'I = V/R',  p: 'P = V·I',
             xlo: 'Low',          xhi: 'High',         ylo: 'Low',        yhi: 'High' },
    water: { x: 'Pipe narrowness →', y: 'Pressure head →',            v: 'Head',    r: 'Pipe R', i: 'Flow',    p: 'Power',
             xlo: 'Low',          xhi: 'High',         ylo: 'Low',        yhi: 'High' },
    biz:   { x: 'Switching cost →',  y: 'Trigger / pressure →',          v: 'Trigger', r: 'Cost',  i: 'Adoption', p: 'Throughput',
             xlo: 'New',  xhi: 'Entrenched',  ylo: 'Low', yhi: 'High' }
  },
